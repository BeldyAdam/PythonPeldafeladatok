def elso():
    ...
    while i <= letszam:
        ...
        if eredmeny <= elozo_eredmeny:
            szigoruan_monoton = False
    ...
    if szigoruan_monoton:
        print("A bekért eredmények szigorúan monoton sorrendben vannak.")
    else:
        print("A bekért eredmények nem szigorúan monoton sorrendben vannak.")